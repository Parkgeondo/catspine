...
// Webviews can attach the page while hidden/zero-sized (e.g. mini-app preload),
// so also observe the stage itself and resize whenever its layout settles.
...
initRanking(state);
// 디버깅/테스트용 상태 핸들 (게임 상태는 어차피 클라이언트 신뢰 안 함)
window.__catspin = state;
